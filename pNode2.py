...
class PeerNode:
    ...
    async def handle_client(self, reader, writer):
        while True:
            ...
            response = f"Node 2 processed: {message}"
    ...
    async def read_instructions(self, file_path):
        ...
        self.instructions = [instr for instr in instructions if instr.startswith('b')]
